...
import { updateStudents } from "./graphql/mutations";
...
export default function StudentsUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setDependencyStatus(cleanValues.dependencyStatus);
    setHouseholdSize(cleanValues.householdSize);
    setErrors({});
  };
      ...
      const record = idProp
        ? (
            await client.graphql({
              query: getStudents.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getStudents
        : studentsModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateStudents.replaceAll("__typename", ""),
            variables: {
              input: {
                id: studentsRecord.id,
                ...modelFields,
              },
            },
          });
