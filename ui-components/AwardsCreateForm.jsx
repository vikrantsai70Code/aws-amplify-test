...
export default function AwardsCreateForm(props) {
  ...
  const resetStateValues = () => {
    setAwardId(initialValues.awardId);
    setFafsaId(initialValues.fafsaId);
    setPellGrantEligibility(initialValues.pellGrantEligibility);
    setLoanEligibility(initialValues.loanEligibility);
    setAwardDecision(initialValues.awardDecision);
    setAwardPackageDetails(initialValues.awardPackageDetails);
    setErrors({});
  };
  const validations = {
    awardId: [],
